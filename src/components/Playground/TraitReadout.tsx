      ...
      {TRAIT_ORDER.map((id) => {
        ...
        return (
          <div key={id} className="flex items-center gap-1.5">
            <span className="w-9 shrink-0 text-[9px] font-mono">{TRAITS[id].tag}</span>
            <div className="relative flex-1 h-2 win-sunken overflow-hidden">
              <div className="absolute inset-y-0 left-0" style={{ width: `${r.measured}%`, background: "var(--color-shadow)" }} />
              <div
